...
<template>
  <div class="col-md-12">
  <form class="row gy-2 gx-3 align-items-center" type="submit" @submit.prevent="onSubmit($event)">
    <div class="col-auto">
    ...
    <div class="col-auto">
      ...
      <div class="row">
        ...
        <div class="col align-self-auto"><Datepicker v-model="date" week-start="0"></Datepicker></div>
    ...
    <div class="col-auto">
    <div class="form-outline">
      <label class="form-control-sm" for="password"> Password (six characters): </label>
      <input id="password" class="form-control-sm" type="password" v-model.trim="password" />
